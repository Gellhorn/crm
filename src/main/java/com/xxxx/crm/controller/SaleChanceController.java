...
public class SaleChanceController extends BaseController {
    ...
    public ResultInfo addSaleChance(SaleChance saleChance, HttpServletRequest request) {
        ...
        // 从Cookie中获取当前登录的用户名
        String userName =  userService.selectByPrimaryKey(LoginUserUtil.releaseUserIdFromCookie(request)).getTrueName();
    ...
    public String toSaleChancePage(Integer id, HttpServletRequest request) {
        ...
        if (id != null) {
            ...
            System.out.println(request.getAttribute("saleChance "));
        }
